...
import { GlobalRegistry, TreeNode } from '@oxygen/designable-core'
...
export const TreeNodeWidget: ReactFC<ITreeNodeWidgetProps> = observer(
...
export const ComponentTreeWidget: ReactFC<IComponentTreeWidgetProps> = observer(
